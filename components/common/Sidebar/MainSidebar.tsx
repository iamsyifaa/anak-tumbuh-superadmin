...
// Navigasi utama Super Admin dibatasi pada dashboard, master sekolah, dan akun kepala sekolah.
const NAV_ITEMS = [
...
function MainSidebar({ onClickLogout }: Props) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 flex w-60 flex-col bg-[#203A5B]">
